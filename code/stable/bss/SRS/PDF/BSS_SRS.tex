...
\\ \midrule
Equation & \begin{displaymath}
           \resizeExpression{\symbf{F}=-G\,\frac{{m_{1}}\,{m_{2}}}{{r_{12}}^{2}}}
           \end{displaymath}
\\ \midrule
Description & \begin{symbDescription}
              \item{$\symbf{F}$ is the force (${\text{N}}$)}
              ...
              \end{symbDescription}
\\ \midrule
Notes & The gravitational force between two bodies is proportional to the product of their masses and inversely proportional to the square of the distance between them. This assumes Newtonian gravitation (\hyperref[newtonianGravity]{A:newtonianGravity}) and requires the separation distance to be positive (\hyperref[nonzeroSeparation]{A:nonzeroSeparation}).
...
Description & \begin{symbDescription}
              ...
              \end{symbDescription}
\\ \midrule
Notes & ${a_{\text{x}1}}$ is calculated by solving the ODE together with the initial conditions . This model is derived from Newton's second law (\hyperref[TM:acceleration]{TM:acceleration}), universal gravitation (\hyperref[TM:UniversalGravLaw]{TM:UniversalGravLaw}), and the definitions of velocity (\hyperref[TM:velocity]{TM:velocity}) and relative position (\hyperref[TM:relPosAndSep]{TM:relPosAndSep}), under the center-of-mass constraint (\hyperref[TM:centerOfMass]{TM:centerOfMass}) . The assumptions are: two-body system (\hyperref[twoBody]{A:twoBody}), isolated system (\hyperref[isolated]{A:isolated}), Newtonian gravitation (\hyperref[newtonianGravity]{A:newtonianGravity}), non-relativistic mechanics (\hyperref[nonRelativistic]{A:nonRelativistic}), point masses (\hyperref[pointMass]{A:pointMass}), constant masses (\hyperref[constantMass]{A:constantMass}), inertial reference frame (\hyperref[inertialFrame]{A:inertialFrame}), planar motion (\hyperref[planar]{A:planar}) and non-zero separation (\hyperref[nonzeroSeparation]{A:nonzeroSeparation}).
...
\\
\hyperref[IM:accelX1]{IM:accelX1} & X &  & X & X & X & X &  &  &  & 
\\
\hyperref[IM:accelY1]{IM:accelY1} & X &  & X & X & X & X &  &  &  & 
\\
\hyperref[IM:accelX2]{IM:accelX2} & X &  & X & X & X & X &  &  &  & 
\\
\hyperref[IM:accelY2]{IM:accelY2} & X &  & X & X & X & X &  &  &  & 
...
\begin{figure}[H]
\begin{center}
\includesvg[width=\textwidth, inkscapelatex = false]{../../../../traceygraphs/bss/avsa}
...
\begin{figure}[H]
\begin{center}
\includesvg[width=\textwidth, inkscapelatex = false]{../../../../traceygraphs/bss/avsall}
...
\begin{figure}[H]
\begin{center}
\includesvg[width=\textwidth, inkscapelatex = false]{../../../../traceygraphs/bss/refvsref}
...
\begin{figure}[H]
\begin{center}
\includesvg[width=\textwidth, inkscapelatex = false]{../../../../traceygraphs/bss/allvsr}
...
\begin{figure}[H]
\begin{center}
\includesvg[width=\textwidth, inkscapelatex = false]{../../../../traceygraphs/bss/allvsall}
...
\begin{itemize}
\item{\hyperref{../../../../traceygraphs/bss/avsa.svg}{}{}{TraceGraphAvsA}}
\item{\hyperref{../../../../traceygraphs/bss/avsall.svg}{}{}{TraceGraphAvsAll}}
\item{\hyperref{../../../../traceygraphs/bss/refvsref.svg}{}{}{TraceGraphRefvsRef}}
\item{\hyperref{../../../../traceygraphs/bss/allvsr.svg}{}{}{TraceGraphAllvsR}}
\item{\hyperref{../../../../traceygraphs/bss/allvsall.svg}{}{}{TraceGraphAllvsAll}}
\end{itemize}
